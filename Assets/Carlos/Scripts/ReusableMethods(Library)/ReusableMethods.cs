...
namespace ReusableMethods
{
    ...
    public static class Points
    {
        ...
        //            if (!Vectors.CheckDistance(Vectors.CalculateDirection(Toolbox.Instance.GameManager.Player.ObjectTransform.position, points[i]), furthestDistance))
        //            {
        ...
        //                furthestDistance = Vector3.Distance(Toolbox.Instance.GameManager.Player.ObjectTransform.position, pointToReturn);
        //            }
        //        }
    ...
    /// <summary>
    /// Class containing tools and methods for dealing with Floats
    /// </summary>
    public static class Floats
    {
        /// <summary>
        /// Compares two floats to tell if they are approximately different (with configurable tolerance)
        /// </summary>
        /// <param name="a">First value</param>
        /// <param name="b">Second value</param>
        /// <param name="tolerance">The higher the tolerance, the easier will be to return true </param>
        /// <returns>True if below tolerance, false if not</returns>
